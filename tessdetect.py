...
def find_display_contour(edge_img_arr):
    ...
    contours = cv2.findContours(edge_copy, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
...
def ocr_image(orig_image_arr):
    ...
    return image_to_string(otsu_thresh_image, lang="7seg")


if __name__ == "__main__":
    image_arr = cv2.imread(
        "/home/yanqinghao/code/recognizing-digits/test/bc7637ade7e7ab4d1c7f43c633bc1b1.jpg")
    print(ocr_image(image_arr))
